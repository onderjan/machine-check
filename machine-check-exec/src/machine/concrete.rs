...
#[derive(Clone, Debug, PartialEq, Eq, Hash)]
pub struct State {
    pub state_5: ::mck::MachineBitvector<12u32>,
    pub state_6: ::mck::MachineBitvector<12u32>,
    pub safe: ::mck::MachineBitvector<1u32>,
}
impl State {
    pub fn init(input: &Input) -> State {
        let node_3 = input.input_3;
        let node_4 = ::mck::MachineBitvector::<12u32>::new(0u64);
        let node_5 = node_4;
        let node_6 = node_4;
        let node_9 = ::mck::MachineBitvector::<12u32>::new(1u64);
        ...
        let node_16 = ::mck::MachineBitvector::<12u32>::new(3u64);
