...
impl State {
    pub fn init(input: &Input) -> State {
        ...
        let node_5 = ::mck::MachineBitvector::<4u32>::new(__ssa_tmp_2);
        let node_6 = node_5;
        let __ssa_tmp_5 = 1u64;
        let node_8 = ::mck::MachineBitvector::<4u32>::new(__ssa_tmp_5);
        ...
        let __ssa_tmp_21 = ::mck::MachineBitvector::<4u32>::new(__ssa_tmp_20);
