...
pub mod mark {
    ...
    impl ::mck::MarkMachine for Machine {
        ...
        fn init(
            ...
            let __mck_abstr_node_6 = ::std::ops::Add::add(
                __mck_abstr_node_3,
                __mck_abstr_node_5,
            );
            ...
            let __mck_abstr_node_10 = ::mck::TypedEq::typed_eq(
                __mck_abstr_node_3,
                __mck_abstr_node_8,
            );
            ...
            let __mck_abstr_tmp_12 = ::std::ops::BitOr::bitor(
                __mck_abstr_tmp_10,
                __mck_abstr_tmp_11,
            );
            super::State {
            ...
            let mut __mck_mark_tmp_5 = ::mck::mark::Markable::create_clean_mark(
                &__mck_abstr_tmp_5,
            );
            ...
            let mut __mck_mark_tmp_4 = ::mck::mark::Markable::create_clean_mark(
                &__mck_abstr_tmp_4,
            );
            ...
            ::mck::mark::Join::apply_join(
                &mut __mck_mark_node_3,
                __mck_input_later_mark.state_3,
            );
            ::mck::mark::Join::apply_join(
            ...
            let __mck_tmp_35 = ::mck::mark::Not::not(
                (__mck_abstr_node_10,),
                __mck_mark_tmp_11,
            );
            ::mck::mark::Join::apply_join(&mut __mck_mark_node_10, __mck_tmp_35.0);
            let __mck_tmp_37 = ::mck::mark::Not::not(
                (__mck_abstr_tmp_9,),
                __mck_mark_tmp_10,
            );
            ...
            let __mck_tmp_43 = ::mck::mark::Neg::neg(
                (__mck_abstr_tmp_4,),
                __mck_mark_tmp_5,
            );
            ::mck::mark::Join::apply_join(&mut __mck_mark_tmp_4, __mck_tmp_43.0);
            let __mck_tmp_45 = ::mck::mark::Add::add(
                (__mck_abstr_node_3, __mck_abstr_node_5),
                __mck_mark_node_6,
            );
        ...
        fn next(
            ...
            let __mck_abstr_tmp_16 = ::std::ops::BitOr::bitor(
                __mck_abstr_tmp_14,
                __mck_abstr_tmp_15,
            );
            super::State {
            ...
            let __mck_tmp_45 = ::mck::mark::Not::not(
                (__mck_abstr_node_10,),
                __mck_mark_tmp_15,
            );
            ::mck::mark::Join::apply_join(&mut __mck_mark_node_10, __mck_tmp_45.0);
            let __mck_tmp_47 = ::mck::mark::Not::not(
                (__mck_abstr_tmp_13,),
                __mck_mark_tmp_14,
            );
            ...
            ::mck::mark::Join::apply_join(&mut __mck_mark_tmp_5, __mck_mark_node_8);
            let __mck_tmp_61 = ::mck::mark::Neg::neg(
                (__mck_abstr_tmp_4,),
                __mck_mark_tmp_5,
            );
            ::mck::mark::Join::apply_join(&mut __mck_mark_tmp_4, __mck_tmp_61.0);
            let __mck_tmp_63 = ::mck::mark::Add::add(
                (__mck_abstr_node_3, __mck_abstr_node_5),
                __mck_mark_node_6,
            );
