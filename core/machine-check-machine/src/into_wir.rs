...
use crate::{
    ...
    wir::{WContext, WDescription, WIdent, WProperty, WSpan, WTypeId, YConverted},
};

pub fn create_description(
    items: Vec<Item>,
) -> Result<(WContext, WDescription<YConverted>, Vec<String>), crate::Errors> {
...
) -> Result<(WContext, WProperty<YConverted>, Vec<String>), crate::Errors> {
