use syn::{punctuated::Punctuated, spanned::Spanned, Ident, ImplItem, Item, Path, PathSegment};
...
pub fn process_item_impl(item_impl: &mut syn::ItemImpl) -> Result<Vec<Item>, MachineError> {
