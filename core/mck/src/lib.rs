...
//! https://docs.rs/machine-check). As [machine-check](https://docs.rs/machine-check)
//! generates Rust code using these types and operations and then builds and executes
//! the resulting files, the name of this crate was chosen so the generated absolute
//! paths are as concise as possible.
//!
