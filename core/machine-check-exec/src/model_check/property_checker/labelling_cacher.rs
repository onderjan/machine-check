...
use crate::{
    model_check::property_checker::{value::CheckValue, PropertyChecker},
    space::StateSpace,
    FullMachine,
};
...
impl<'a, M: FullMachine> LabellingCacher<'a, M> {
    pub(super) fn new(property_checker: &'a PropertyChecker, space: &'a StateSpace<M>) -> Self {
        LabellingCacher {
            property_checker,
            space,
        }
