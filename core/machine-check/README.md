...
A very simple example of a system verifiable by **machine-check** is [counter](
    https://docs.rs/crate/machine-check/0.2.0/source/examples/counter.rs), 
...
[conditional_panic](
    https://docs.rs/crate/machine-check/0.2.0/source/examples/conditional_panic.rs) 
...
in [simple_risc](https://docs.rs/crate/machine-check/0.2.0/source/examples/simple_risc.rs), 
