...
For more examples, [read the **machine-check** book](https://book.machine-check.org/0.6.1/) and the [chapter on **machine-check-hw**](https://book.machine-check.org/0.6.1/systems/machine-check-hw.html).
