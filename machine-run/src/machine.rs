...
impl MachineState {
    pub fn init(input: &MachineInput) -> MachineState {
        ...
        let node_10 = ((node_9) & (::machine_check_types::MachineExt::<4u32>::sext(node_2)))
            | ((node_6) & (::machine_check_types::MachineExt::<4u32>::sext(!(node_2))));
        let node_11 = ((node_5) & (::machine_check_types::MachineExt::<4u32>::sext(node_3)))
            | ((node_10) & (::machine_check_types::MachineExt::<4u32>::sext(!(node_3))));
